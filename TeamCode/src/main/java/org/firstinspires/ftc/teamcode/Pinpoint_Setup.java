...
public class Pinpoint_Setup extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public Pinpoint_Setup(I2cDeviceSynchSimple deviceClient, boolean deviceClientIsOwned) {
